...
```bash
npm install @hydra/baileys
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```bash
yarn add @hydra/baileys@latest
```

Then import your code using:
```javascript
const { default: makeWASocket } = require("@hydra/baileys")
```
...
```javascript
const makeWASocket = require("@hydra/baileys").default;
const { useMultiFileAuthState } = require("@hydra/baileys");
...
```javascript
const makeWASocket = require("@hydra/baileys").default;
const { DisconnectReason, useMultiFileAuthState } = require("@hydra/baileys");
...
```javascript
const makeWASocket = require("@hydra/baileys").default;
const { makeInMemoryStore } = require("@hydra/baileys");
...
const { downloadMediaMessage, getContentType } = require("@hydra/baileys");
